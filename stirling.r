...
#abline()
legend('topleft', 
	legend=c(expression(B[k]), 'Any 3 (or less) Ports Can Pool', 'Any 2 (or less) Ports Can Pool', 'Directly Adjacent Ports Can Pool', 'Up to 3 Adjacent Ports Can Pool'),
	lty=rep(1, 5),
	lwd=rep(2, 5),
	col=c('black', pal[2], pal[4], pal[1], pal[3])
)
#5, 16
points(5.3, -30, pch="1", cex=2, col='red')
#274
points(10, 200, pch="2", cex=2, col='red')
#512
points(10, 580, pch="3", cex=2, col='red')
#
dev.off()
