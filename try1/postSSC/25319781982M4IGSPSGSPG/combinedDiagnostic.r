...
baseDir = getwd()
#
run = "/media/nick/extraBig//25319781982M4"
...
setwd(baseDir)
#
run = "/media/nick/extraBig//25319781982M4IGSG"
legend = c(legend, substrRight(strsplit(run, '//')[[1]][2], 12))
samplePath = sprintf('%s/%s%s%s/', run, mcat, minYear, maxYear)
runDir = sprintf('../retune/%s', strsplit(run, '//')[[1]][2])
setwd(runDir)
...
setwd(baseDir)
#
run = "/media/nick/extraBig//25319781982M4IGSP"
legend = c(legend, substrRight(strsplit(run, '//')[[1]][2], 12))
samplePath = sprintf('%s/%s%s%s/', run, mcat, minYear, maxYear)
runDir = sprintf('../retune/%s', strsplit(run, '//')[[1]][2])
setwd(runDir)
...
setwd(baseDir)
#
run = "/media/nick/extraBig//25319781982M4IGSPG"
legend = c(legend, substrRight(strsplit(run, '//')[[1]][2], 12))
samplePath = sprintf('%s/%s%s%s/', run, mcat, minYear, maxYear)
runDir = sprintf('../retune/%s', strsplit(run, '//')[[1]][2])
setwd(runDir)
