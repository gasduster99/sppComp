...
#
runPaths = Sys.glob(sprintf("%s/*%s%sM4IGSP/", globPath, minYear, maxYear))
legend = c(legend, subRight(runPaths[1], 34))
print(legend)
#
expDistMY = expandDistByMcatYear(land, runPaths, portGold, gearGold, yearGold, qtrGold)
...
#
runPaths = Sys.glob(sprintf("%s/*%s%sM4IGSG/", globPath, minYear, maxYear))
legend = c(legend, subRight(runPaths[1], 34))
print(legend)
#
expDistMY = expandDistByMcatYear(land, runPaths, portGold, gearGold, yearGold, qtrGold)
...
#
dirName = 'M4IGSPSG/' #subRight(runPaths[1], 34)
plotLands(summarizeDistY0, summarizeDistY1, summarizeDistY2, dirName=dirName, col=cols[1:length(legend)], legend=legend)
