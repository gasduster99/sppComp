...
##
#runPaths = Sys.glob(sprintf("%s/*%s%sM3/", globPath, minYear, maxYear))
#legend = c(legend, subRight(runPaths[1], 34))
#print(legend)
##
#expDistMY = expandDistByMcatYear(land, runPaths, portGold, gearGold, yearGold, qtrGold)
...
#
runPaths = Sys.glob(sprintf("%s/*%s%sM5/", globPath, minYear, maxYear))
legend = c(legend, subRight(runPaths[1], 34))
print(legend)
#
expDistMY = expandDistByMcatYear(land, runPaths, portGold, gearGold, yearGold, qtrGold)
...
#
runPaths = Sys.glob(sprintf("%s/*%s%sM6/", globPath, minYear, maxYear))
legend = c(legend, subRight(runPaths[1], 34))
print(legend)
#
expDistMY = expandDistByMcatYear(land, runPaths, portGold, gearGold, yearGold, qtrGold)
...
#
dirName = 'M2M3M4M5M6/' #subRight(runPaths[1], 34)
plotLands(summarizeDistY00, summarizeDistY1, summarizeDistY2, summarizeDistY3, dirName=dirName, col=cols[1:length(legend)], legend=legend)
