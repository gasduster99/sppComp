...
%\subsection{}
\begin{frame}{\color{red}{show sppComp distribution for some strata}}
%%\vspace{-0.3cm}
\hspace*{-0.8cm}
\begin{minipage}{0.3\textwidth}
%$~$\\\vspace{-1cm} 
\vspace*{-0.25cm}
\centering\textbf{HKL}
\includegraphics[height=0.37\textheight]{../pictures/vioOSBHKL.pdf}\\
\vspace*{-1.3cm}
\includegraphics[height=0.37\textheight]{../pictures/vioOLAHKL.pdf}\\
\vspace*{-1.3cm}
\includegraphics[height=0.37\textheight]{../pictures/vioOSDHKL.pdf}
\end{minipage}
\hspace*{0.5cm}
\begin{minipage}{0.3\textwidth}
\vspace*{-0.25cm}
\centering\textbf{NET}
\includegraphics[height=0.37\textheight]{../pictures/vioOSBNET.pdf}\\
\vspace*{-1.3cm}
\includegraphics[height=0.37\textheight]{../pictures/vioOLANET.pdf}\\
\vspace*{-1.3cm}
\includegraphics[height=0.37\textheight]{../pictures/vioOSDNET.pdf}
\end{minipage}
\hspace*{0.5cm}
\begin{minipage}{0.3\textwidth}
\vspace*{-0.25cm}
\centering\textbf{TWL}
\includegraphics[height=0.37\textheight]{../pictures/vioOSBTWL.pdf}\\
\vspace*{-1.3cm}
\includegraphics[height=0.37\textheight]{../pictures/vioOLATWL.pdf}\\
\vspace*{-1.3cm}
\includegraphics[height=0.37\textheight]{../pictures/vioOSDTWL.pdf}
\end{minipage}
\end{frame}
...
%\vspace{-0.5cm}
\hspace*{-1cm}
\includegraphics[width=0.6\textwidth]{../pictures/northern269.pdf}
\includegraphics[width=0.6\textwidth]{../pictures/southern269.pdf}\\
\vspace{-0.5cm}
\hspace*{-0.3cm}
\includegraphics[height=0.37\textheight]{../pictures/space10MapTop.pdf}
\includegraphics[height=0.37\textheight]{../pictures/space9MapTop.pdf}
\includegraphics[height=0.37\textheight]{../pictures/space14MapTop.pdf}
\includegraphics[height=0.37\textheight]{../pictures/space4MapTop.pdf}
\hspace*{0.9cm}
\includegraphics[height=0.37\textheight]{../pictures/space2MapBottom.pdf}
\includegraphics[height=0.37\textheight]{../pictures/space4MapBottom.pdf}
\includegraphics[height=0.37\textheight]{../pictures/space5MapBottom.pdf}
\includegraphics[height=0.37\textheight]{../pictures/space1MapBottom.pdf}
\end{frame}
