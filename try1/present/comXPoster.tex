...
of several major sources of uncertainty. % in species composition estimates.
...
\headerbox{5. Results}{name=results,column=0,below=examples,span=2}{
	\begin{minipage}[h!]{0.49\textwidth}
                \hspace*{-0.2cm}
                \includegraphics[width=1\textwidth]{../pictures/avgOrNotBox.pdf}
        \end{minipage}
        \begin{minipage}[h!]{0.49\textwidth}
		\hspace*{-0.75cm}
...
%
\headerbox{6. Conclusion}{name=conclusion,column=2,below=colorTable,span=1}{
