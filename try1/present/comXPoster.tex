...
%
\headerbox{1. Introduction}{name=introduction,column=0,row=0.06,span=3}{
...
sampling data. Furthermore combining Bayesian hierarchical models with BMA allows for 
a complete statistical summary of the major sources of uncertainty in species 
composition estimates.
}

%
\headerbox{2. Model}{name=model,column=0,below=introduction,span=1}{
...
%
\headerbox{3. Model Exploration}{name=explore,column=1,below=introduction,span=1}{
	\underline{\textbf{Number of Partitioned Models:}}
	...
	$\bar{\text{B}}_{K}$: Groupings are small ($\le$3 Ports) 		\\
	$\hat{\text{B}}_{K}$: Groupings are contiguous			\\
	$\hat{\bar{\text{B}}}_{K}$: Groupings are small and contiguous	\\
	\vspace{0.1cm}
}

%
\headerbox{4. Bayesian Model Averaging}{name=bma,column=2,below=introduction,span=1}{
...
%
\headerbox{Unspecified Rockfish: 1978-1982}{name=250,column=2,below=bma,span=1}{
	\resizebox{1\textwidth}{!}{\begin{tabular}{|c|c|c|c|c|c|}%c|c|c|c|}
...
%
\headerbox{5. Results}{name=results,column=0,below=examples,span=2}{

}

%
\headerbox{6. Conclusion}{name=conclusion,column=2,below=250,span=1}{
