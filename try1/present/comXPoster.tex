...
\headerbox{3. Model Exploration}{name=explore,column=1,below=introduction,span=1}{
	...
	$\bar{\text{B}}_{K}$: Groupings are small (<3 Ports) 		\\
...
\headerbox{$\text{B}_{10}=115975$ $~~~~~$ $\bar{\text{B}}_{10}=61136$ $~~~~~$ $\hat{\text{B}}_{10}=512$ $~~~~~$ $\hat{\bar{\text{B}}}_{10}=274$}{name=examples,column=0,below=bma,span=2}{
	\begin{minipage}[h!]{0.19\textwidth}
	        %\hspace*{-0.5cm}
	        \includegraphics[width=0.8\textwidth]{../pictures/mapFullBlank.pdf}
	\end{minipage}
	\begin{minipage}[h!]{0.19\textwidth}
	        %\hspace*{-0.25cm}
	        \includegraphics[width=0.8\textwidth]{../pictures/mapFullHalfHalf.pdf}
	\end{minipage}
	\begin{minipage}[h!]{0.19\textwidth}
	        %\hspace*{0.25cm}
	        \includegraphics[width=0.8\textwidth]{../pictures/mapLeapFrog.pdf}
	\end{minipage}
	\begin{minipage}[h!]{0.19\textwidth}
	        %\hspace*{0.25cm}
	        \includegraphics[width=0.8\textwidth]{../pictures/mapFullConcMend.pdf}
	\end{minipage}	
	\begin{minipage}[h!]{0.19\textwidth}
	        %\hspace*{0.5cm}                %1.2
	        \includegraphics[width=0.8\textwidth]{../pictures/mapFullSparse.pdf}
	\end{minipage}
}
...
%%
%\headerbox{5. Results}{name=results,column=1,below=bma,span=2}{
%
%}
%
%%
