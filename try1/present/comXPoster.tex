...
%----------------------------------------------------------------------------------------
%
{\includegraphics[width=0.2\textwidth]{../pictures/noaa.jpeg}}
{
\textsf %Sans Serif
...
{\includegraphics[width=0.2\textwidth]{../pictures/fiatSlug.jpg}}%{\includegraphics{logo}} % University/lab logo
...
DeCAF is written as an open source Python module (\textbf{\color{darkblue}http://bitbucket.org/marta-sd/decaf}) and can be easily combined with RDKit to facilitate ligand-based drug design.
}
