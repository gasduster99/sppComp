...
\textbf{Response:}
The following 4 slides show some comparisons bewteen MCAT 250 where we include 
or exlude ports south of Point Conception. Beyond this point all other model 
runs, and plots, only model ports north of Point Conception.
...
\begin{frame}
	...
	correlated (I prove this later). The components of a new (multivariate) random variable 
...
\begin{frame}
	...
	\begin{minipage}{0.29\textwidth}
	\hspace*{0.5cm}
	\includegraphics[width=\textwidth]{./pictures/heatPlot.jpg}\\
	\hspace*{0.5cm}
...
\begin{frame}
\begin{center}
\includegraphics[height=\textheight]{./pictures/253Pairs.jpg}
\end{center}
\end{frame}
