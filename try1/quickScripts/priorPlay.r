...
#
writeLines('V MODEL')
out = inla(weight~species + portComplex + gear + f(QGivenY), 
       	Ntrials=DAT$clustSize, family='betabinomial', data=DAT, num.threads=cores,
	#control.inla=list(
	#	 strategy='gaussian',
        #        int.strategy='eb',
...
#write.csv(format(metrics, scientific=T, digits=10), file="./metrics.csv", row.names=F, quote=F)
