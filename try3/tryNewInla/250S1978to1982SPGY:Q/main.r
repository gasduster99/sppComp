...
#
mcat = 250 
minYear = 1978 #1983 #1978 #1984 #1991 #
maxYear = 1982 #1990 #1983 #1990 #2001 #
...
raw = getRawData(mcat, minYear, maxYear, save=T, fromFile="250data78To83_2024-11-13.csv") #T)
#define sppGold from the data
spp  = unique(raw$species)
sppGold = spp
...
MM = 10000 
thin = 1
warmFrac = seq(0.1, 0.9, 0.1)[5] #1/3
