...
#
#mod = "250N1978to1982SPGY:QZero"
mod = "250N1983to1990SPGY:QZero"
path = sprintf("./%s/", mod) #"./250N1978to1982SPGY:Q/"
load(sprintf('%s/data%s.RData', path, mod))
out = readRDS(sprintf('%s/brms%s.rds', path, mod))
