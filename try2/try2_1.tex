...
relationship as well as the structure, and scope, of residual variation. Here 
the poisson, binomial, negative binomial, and beta-binomial distributions are 
considered as possible forms for $f$. These distributions span the vast majority 
of commonly used univariate whole number distributions. 
