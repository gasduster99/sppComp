...
the simplest ways to see the principle is in the structure of the MSE 
...
%
Random effects are typically groupings of many parameters that can be 
...
holders for a particular fixed or random effect to be included in the model. 
Each effect to be included in the model is either included as a fixed or 
random effect. The particular effects to be included in the linear predictor 
are discussed later in section \ref{lp}.
...
structure among categories. %oracle: prior conception
