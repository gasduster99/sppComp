...
effort can operate with the oracle of some previously understood correlation %oracle: prior conception 
...
strata. %through a parsimonious model of the linear predictor $\theta_{jklm\nu}$. 
